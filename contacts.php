...
$connection = mysqli_connect('localhost', 'root', '', 'myicdproject');


$query = "INSERT INTO `goobweb` (`firstname`, `lastname`, `youremail`, `yourphone`, `installationservice`, `price`, `detail`) VALUES ('$first_name', '$last_name', '$email', '$phone', '$select_service', '$select_price', '$comments')";
